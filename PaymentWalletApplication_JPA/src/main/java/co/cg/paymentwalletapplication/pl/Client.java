package co.cg.paymentwalletapplication.pl;
...
import co.cg.paymentwalletapplication.service.IWalletService;
import co.cg.paymentwalletapplication.service.WalletServiceImpl;
...
public class Client {
	public static void main(String[] args) {
		...
		do {
			...
			System.out.println("                                                                  ");
			System.out.println("___________________Payment Wallet Application_____________________");
	...
	private static void login(Customer customerBean) {
		int choiceLogin = 0;
		Scanner scanner = new Scanner(System.in);
		System.out.println("Welcome... " + customerBean.getName() + " You are successfully logged in.... ");
		do {
			System.out.println("                                                                                    ");
			System.out.println("_______________________________Payment Wallet Application___________________________");
			...
			case 2:
				...
				if (service.withdrawAmount(withdrawAmount, mobNum)) {
					...
					Customer bean2 = service.showBalance(mobNum);
			...
			case 3:
				...
				if (service.depositAmount(depositAmount, mobNum1)) {
					...
					Customer bean3 = service.showBalance(mobNum1);
			...
			case 4:
				...
				try {
					if (service.fundTransfer(senderMobNum, receiverMobNum, transferAmount)) {
						...
						Customer bean4 = service.showBalance(senderMobNum);
			...
			case 6:
				System.out.println("_____________________________Logged Out Successfully________________________________");
